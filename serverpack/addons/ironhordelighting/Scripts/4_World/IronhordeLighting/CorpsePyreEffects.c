class IH_Heat_BurningBodies extends IH_ConfigurableLightEntityBase
{
	...
	static int CORPSE_PILE_SMOKE_SOFT = ParticleList.RegisterParticle("IronhordeLighting/graphics/Particles/", "IH_CorpseHaze_Low");
	static int CORPSE_PILE_SMOKE_DENSE = ParticleList.RegisterParticle("IronhordeLighting/graphics/Particles/", "IH_CorpseHaze_Heavy");
	static int CORPSE_PILE_FIRE_CORE = ParticleList.RegisterParticle("IronhordeLighting/graphics/Particles/", "IH_CorpsePyre_Core");
	...
	void IH_Heat_BurningBodies()
	{
		...
		{
			m_FireEmitter = Particle.PlayOnObject(CORPSE_PILE_FIRE_CORE, this, Vector(0, 0.05, 0), Vector(0, 0, 0), true);
			m_SmokeEmitter = Particle.PlayOnObject(CORPSE_PILE_SMOKE_DENSE, this, Vector(0, 0.05, 0), Vector(0, 0, 0), true);
		}
