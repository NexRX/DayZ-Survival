...
class CfgMods {
    class TerjeSkills {
        ...
        class defs {
            class imageSets {
                files[] = {"TerjeSkills/Textures/Icons/TerjeSkills.imageset", "TerjeSkills/Textures/Icons/PerkBorders.imageset", "TerjeSkills/Textures/Icons/PerkLevels.imageset", "TerjeSkills/Textures/Icons/TerjePerk.imageset", "TerjeSkills/Textures/Icons/TerjePerkBlack.imageset"};
            };
...
class CfgTerjeSkills {
    class SkillsBase {
        ...
        expLoseOnDeath = -100;
        levels[] = {100, 200, 300, 400, 500, 700, 900, 1100, 1300, 1500, 1750, 2000, 2250, 2500, 2750, 3250, 3750, 4250, 4750, 5250, 6000, 6750, 7500, 8250, 9000, 10000, 11000, 12000, 13000, 14000, 16000, 18000, 20000, 22000, 24000, 26000, 28000, 30000, 32000, 34000, 37000, 40000, 43000, 46000, 50000, 55000, 60000, 70000, 80000, 100000};
    };
