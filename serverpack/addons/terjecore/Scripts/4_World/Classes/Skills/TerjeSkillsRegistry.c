static ref TerjeSkillsRegistry m_TerjeSkillsRegistryInstance = null;
TerjeSkillsRegistry GetTerjeSkillsRegistry()
{
	if (m_TerjeSkillsRegistryInstance == null)
	{
		m_TerjeSkillsRegistryInstance = new TerjeSkillsRegistry;
		m_TerjeSkillsRegistryInstance.OnInit();
	}
	
	return m_TerjeSkillsRegistryInstance;
}
