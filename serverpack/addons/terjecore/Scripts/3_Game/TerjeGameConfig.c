...
static ref TerjeGameConfig m_TerjeGameConfigInstance = null;
TerjeGameConfig GetTerjeGameConfig()
{
	if (m_TerjeGameConfigInstance == null)
	{
		m_TerjeGameConfigInstance = new TerjeGameConfig;
		m_TerjeGameConfigInstance.OnInit();
	}
	
	return m_TerjeGameConfigInstance;
}