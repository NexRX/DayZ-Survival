import type { ClassName } from "../types/classNamesGenerated.d.ts";
import type { ChernarusClassNames } from "../types/classNamesLarge.d.ts";
...
export type ClassNameModded =
  ...
  | "ExpansionQuestDryBag_Green"
  | "ExpansionQuestDryBag_Black"
  | "ExpansionQuestDryBag_Red"
  | "QPK_Quest_Album"
  | "OPK_Quest_BankCase"
  | "OPK_Quest_CCPT90"
  | "QPK_Quest_Envelope"
  | "OPK_Quest Controller_Engine"
  | "QPK_Quest_Controller_GALS"
  | "QPK_Quest_PackingList_OLI"
  | "QPK_Quest_PackingList_OLI_n"
  | "QPK_Quest_PackingList_Goshan"
  | "OPK_Quest_PackingList_IDEA"
  | "OPK_Quest_Parcel"
  | "QPK_Quest_ProtectionCase_0013"
  | "QPK_Quest_ProtectionCase_0022"
  | "QPK_Quest_ProtectionCase_0031"
  | "QPK_Quest_ProtectionCase_0048"
  | "QPK_Quest_ProtectionCase_0052"
  | "QPK_Quest_ProtectionCase_0060"
  // Crafting section
