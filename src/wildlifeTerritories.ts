// Wires up wildlife mods (Raven, Rat, Horse, Dog, Ambient Animals Pack) by
// performing the manual setup steps each mod's readme normally asks an admin
// to do:
...
${
  ...
  // Ambient Animals Pack (@Ambient-Animals-Pack, id 3114410963): ships its own
  // raven + rat territory files too, but those are intentionally skipped here
  // in favor of the dedicated @DayZ-Raven / @DayZ-Rat entries above (avoids
  // registering colliding/duplicate territory-file usable names). Only the 5
  // species without an existing dedicated mod are wired: Otter, Rabbit,
  // Seagull, Squirrel, Snake. All verified from the mod's own per-species
  // readme.txt files under server/@Ambient-Animals-Pack/*_territories/.
  {
    modName: "@Ambient-Animals-Pack",
    sourceFile: "otter_territories/chernarus/otter_territories.xml",
    envFileName: "otter_territories.xml",
    territoryBlock: `\t\t<!-- OTTER -->
...
\t\t\t<item name="playerSpawnRadiusFar" val="75" />
\t\t</territory>`,
    eventBlock: `    <event name="AmbientOtter">
        <nominal>3</nominal>
        <min>0</min>
        <max>20</max>
        <lifetime>33</lifetime>
  ...
  {
    modName: "@Ambient-Animals-Pack",
    sourceFile: "rabbit_territories/chernarus/rabbit_territories.xml",
    envFileName: "rabbit_territories.xml",
    territoryBlock: `\t\t<!-- RABBIT -->
...
\t\t\t<item name="playerSpawnRadiusFar" val="75" />
\t\t</territory>`,
    eventBlock: `    <event name="AmbientRabbit">
        <nominal>3</nominal>
        <min>0</min>
        <max>50</max>
        <lifetime>33</lifetime>
  ...
  {
    modName: "@Ambient-Animals-Pack",
    sourceFile: "seagull_territories/chernarus/seagull_territories.xml",
    envFileName: "seagull_territories.xml",
    territoryBlock: `\t\t<!-- SEAGULL -->
...
\t\t\t<item name="playerSpawnRadiusFar" val="75" />
\t\t</territory>`,
    eventBlock: `    <event name="AmbientSeagull">
        <nominal>3</nominal>
        <min>0</min>
        <max>50</max>
        <lifetime>33</lifetime>
  ...
  {
    modName: "@Ambient-Animals-Pack",
    sourceFile: "squirrel_territories/chernarus/squirrel_territories.xml",
    envFileName: "squirrel_territories.xml",
    territoryBlock: `\t\t<!-- SQUIRREL -->
...
\t\t\t<item name="playerSpawnRadiusFar" val="75" />
\t\t</territory>`,
    eventBlock: `    <event name="AmbientSquirrel">
        <nominal>3</nominal>
        <min>0</min>
        <max>50</max>
        <lifetime>33</lifetime>
  ...
  {
    modName: "@Ambient-Animals-Pack",
    sourceFile: "snake_territories/chernarus/snake_territories.xml",
    envFileName: "snake_territories.xml",
    territoryBlock: `\t\t<!-- SNAKE -->
\t\t<territory type="Herd" name="Snake" behavior="DZSnakeGroupBeh">
\t\t\t<file usable="snake_territories" />
\t\t</territory>`,
    eventBlock: `    <event name="AnimalSnake">
        <nominal>6</nominal>
        <min>4</min>
        <max>6</max>
        <lifetime>180</lifetime>
    ...
    eventSpawnsBlock: `    <event name="AnimalSnake" />`,
  },
];
...
export async function ensureWildlifeTerritories(mods: Mod[]): Promise<void> {
  ...
  for (const mod of mods) {
    // A single mod (e.g. @Ambient-Animals-Pack) may contribute several
    // territories (one per animal species), so every match is processed -
    // not just the first.
    const territories = TERRITORIES.filter((x) => x.modName === mod.name);
